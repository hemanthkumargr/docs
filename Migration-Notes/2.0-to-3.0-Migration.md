...
If you would like to see an absolutely comprehensive list of all changes that were made to our sample application between 2.0 and 3.0, you can utilize [this GitHub branch compare link](https://github.com/BroadleafCommerce/DemoSite/compare/BroadleafCommerce-2.0.x...admin3).
