...
--
-- Host: localhost    Database: broadleaf16
-- ------------------------------------------------------
...
CREATE TABLE `BLC_ADMIN_USER_SANDBOX` (
  ...
  KEY `FKD0A97E099B942795` (`SANDBOX_ID`),
  CONSTRAINT `FKD0A97E099B942795` FOREIGN KEY (`SANDBOX_ID`) REFERENCES `BLC_SANDBOX` (`SANDBOX_ID`),
...
CREATE TABLE `BLC_DISCRETE_ORDER_ITEM` (
  `BASE_RETAIL_PRICE` decimal(19,2) DEFAULT NULL,
  `BASE_SALE_PRICE` decimal(19,2) DEFAULT NULL,
  `ORDER_ITEM_ID` bigint(20) NOT NULL,
  `BUNDLE_ORDER_ITEM_ID` bigint(20) DEFAULT NULL,
  `PRODUCT_ID` bigint(20) DEFAULT NULL,
  `SKU_ID` bigint(20) NOT NULL,
  PRIMARY KEY (`ORDER_ITEM_ID`),
  KEY `DISCRETE_BUNDLE_INDEX` (`BUNDLE_ORDER_ITEM_ID`),
...
CREATE TABLE `BLC_FULFILLMENT_GROUP` (
  ...
  `CITY_TAX` decimal(19,5) DEFAULT NULL,
  `COUNTRY_TAX` decimal(19,5) DEFAULT NULL,
  `COUNTY_TAX` decimal(19,5) DEFAULT NULL,
  `DELIVERY_INSTRUCTION` varchar(255) DEFAULT NULL,
  `DISTRICT_TAX` decimal(19,5) DEFAULT NULL,
  ...
  `STATE_TAX` decimal(19,5) DEFAULT NULL,
...
CREATE TABLE `BLC_PAGE` (
  ...
  KEY `FKF41BEDD59B942795` (`SANDBOX_ID`),
  KEY `FKF41BEDD553908C53` (`ORIG_SANDBOX_ID`),
  ...
  CONSTRAINT `FKF41BEDD553908C53` FOREIGN KEY (`ORIG_SANDBOX_ID`) REFERENCES `BLC_SANDBOX` (`SANDBOX_ID`),
  CONSTRAINT `FKF41BEDD59B942795` FOREIGN KEY (`SANDBOX_ID`) REFERENCES `BLC_SANDBOX` (`SANDBOX_ID`),
...
--
-- Table structure for table `BLC_PRODUCT_IMAGE`
--

DROP TABLE IF EXISTS `BLC_PRODUCT_IMAGE`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `BLC_PRODUCT_IMAGE` (
  ...
  KEY `FK5B3A11455F11A0B7` (`PRODUCT_ID`),
  CONSTRAINT `FK5B3A11455F11A0B7` FOREIGN KEY (`PRODUCT_ID`) REFERENCES `BLC_PRODUCT` (`PRODUCT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `BLC_PRODUCT_IMAGE`
--

LOCK TABLES `BLC_PRODUCT_IMAGE` WRITE;
/*!40000 ALTER TABLE `BLC_PRODUCT_IMAGE` DISABLE KEYS */;
/*!40000 ALTER TABLE `BLC_PRODUCT_IMAGE` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `BLC_PRODUCT_MEDIA_MAP`
--

DROP TABLE IF EXISTS `BLC_PRODUCT_MEDIA_MAP`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `BLC_PRODUCT_MEDIA_MAP` (
  `BLC_PRODUCT_PRODUCT_ID` bigint(20) NOT NULL,
  `MEDIA_ID` bigint(20) NOT NULL,
  `MAP_KEY` varchar(255) NOT NULL,
  PRIMARY KEY (`BLC_PRODUCT_PRODUCT_ID`,`MAP_KEY`),
  KEY `FKD5AE994B1C6D3EAD` (`BLC_PRODUCT_PRODUCT_ID`),
  KEY `FKD5AE994B19D1156C` (`MEDIA_ID`),
  CONSTRAINT `FKD5AE994B19D1156C` FOREIGN KEY (`MEDIA_ID`) REFERENCES `BLC_MEDIA` (`MEDIA_ID`),
  CONSTRAINT `FKD5AE994B1C6D3EAD` FOREIGN KEY (`BLC_PRODUCT_PRODUCT_ID`) REFERENCES `BLC_PRODUCT` (`PRODUCT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `BLC_PRODUCT_MEDIA_MAP`
--

LOCK TABLES `BLC_PRODUCT_MEDIA_MAP` WRITE;
/*!40000 ALTER TABLE `BLC_PRODUCT_MEDIA_MAP` DISABLE KEYS */;
/*!40000 ALTER TABLE `BLC_PRODUCT_MEDIA_MAP` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `BLC_PRODUCT_SKU`
--

DROP TABLE IF EXISTS `BLC_PRODUCT_SKU`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `BLC_PRODUCT_SKU` (
  `PRODUCT_ID` bigint(20) NOT NULL,
  `SKU_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`PRODUCT_ID`),
  KEY `FKA71F1B87B78C9977` (`SKU_ID`),
  KEY `FKA71F1B875F11A0B7` (`PRODUCT_ID`),
  CONSTRAINT `FKA71F1B875F11A0B7` FOREIGN KEY (`PRODUCT_ID`) REFERENCES `BLC_PRODUCT` (`PRODUCT_ID`),
  CONSTRAINT `FKA71F1B87B78C9977` FOREIGN KEY (`SKU_ID`) REFERENCES `BLC_SKU` (`SKU_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `BLC_PRODUCT_SKU`
--

LOCK TABLES `BLC_PRODUCT_SKU` WRITE;
/*!40000 ALTER TABLE `BLC_PRODUCT_SKU` DISABLE KEYS */;
/*!40000 ALTER TABLE `BLC_PRODUCT_SKU` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `BLC_SANDBOX_ITEM` (
  ...
  KEY `FK48435EF19B942795` (`SANDBOX_ID`),
  KEY `FK48435EF153908C53` (`ORIG_SANDBOX_ID`),
  ...
  CONSTRAINT `FK48435EF153908C53` FOREIGN KEY (`ORIG_SANDBOX_ID`) REFERENCES `BLC_SANDBOX` (`SANDBOX_ID`),
  CONSTRAINT `FK48435EF19B942795` FOREIGN KEY (`SANDBOX_ID`) REFERENCES `BLC_SANDBOX` (`SANDBOX_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `BLC_SC` (
  ...
  KEY `FK74EEB7169B942795` (`SANDBOX_ID`),
  KEY `FK74EEB71653908C53` (`ORIG_SANDBOX_ID`),
  ...
  CONSTRAINT `FK74EEB71653908C53` FOREIGN KEY (`ORIG_SANDBOX_ID`) REFERENCES `BLC_SANDBOX` (`SANDBOX_ID`),
  CONSTRAINT `FK74EEB71671EBFA46` FOREIGN KEY (`SC_TYPE_ID`) REFERENCES `BLC_SC_TYPE` (`SC_TYPE_ID`),
  CONSTRAINT `FK74EEB7169B942795` FOREIGN KEY (`SANDBOX_ID`) REFERENCES `BLC_SANDBOX` (`SANDBOX_ID`),
...
CREATE TABLE `BLC_SITE` (
  ...
  PRIMARY KEY (`SITE_ID`),
  KEY `FKF41D6A8DA8E00EDB` (`PRODUCTION_SANDBOX_ID`),
  CONSTRAINT `FKF41D6A8DA8E00EDB` FOREIGN KEY (`PRODUCTION_SANDBOX_ID`) REFERENCES `BLC_SANDBOX` (`SANDBOX_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `BLC_SITE_SANDBOX` (
  ...
  KEY `FKAD4F7EF59B942795` (`SANDBOX_ID`),
  KEY `FKAD4F7EF5EFCAA45F` (`SITE_ID`),
  CONSTRAINT `FKAD4F7EF5EFCAA45F` FOREIGN KEY (`SITE_ID`) REFERENCES `BLC_SITE` (`SITE_ID`),
  CONSTRAINT `FKAD4F7EF59B942795` FOREIGN KEY (`SANDBOX_ID`) REFERENCES `BLC_SANDBOX` (`SANDBOX_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `BLC_SKU_IMAGE`
--

DROP TABLE IF EXISTS `BLC_SKU_IMAGE`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `BLC_SKU_IMAGE` (
  ...
  KEY `FK1D7F6BF3B78C9977` (`SKU_ID`),
  CONSTRAINT `FK1D7F6BF3B78C9977` FOREIGN KEY (`SKU_ID`) REFERENCES `BLC_SKU` (`SKU_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `BLC_SKU_IMAGE`
--

LOCK TABLES `BLC_SKU_IMAGE` WRITE;
/*!40000 ALTER TABLE `BLC_SKU_IMAGE` DISABLE KEYS */;
/*!40000 ALTER TABLE `BLC_SKU_IMAGE` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `BLC_STATIC_ASSET` (
  ...
  KEY `FK9875FB059B942795` (`SANDBOX_ID`),
  KEY `FK9875FB0553908C53` (`ORIG_SANDBOX_ID`),
  ...
  CONSTRAINT `FK9875FB0553908C53` FOREIGN KEY (`ORIG_SANDBOX_ID`) REFERENCES `BLC_SANDBOX` (`SANDBOX_ID`),
  CONSTRAINT `FK9875FB059B942795` FOREIGN KEY (`SANDBOX_ID`) REFERENCES `BLC_SANDBOX` (`SANDBOX_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `BLC_USER_ROLE`
--

DROP TABLE IF EXISTS `BLC_USER_ROLE`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `BLC_USER_ROLE` (
  ...
  KEY `USERROLE_USER_INDEX` (`USER_ID`),
  KEY `FK21B77CE4B8587B7` (`ROLE_ID`),
  KEY `FK21B77CE4B0B09917` (`USER_ID`),
  CONSTRAINT `FK21B77CE4B0B09917` FOREIGN KEY (`USER_ID`) REFERENCES `BLC_USER` (`USER_ID`),
  CONSTRAINT `FK21B77CE4B8587B7` FOREIGN KEY (`ROLE_ID`) REFERENCES `BLC_ROLE` (`ROLE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `BLC_USER_ROLE`
--

LOCK TABLES `BLC_USER_ROLE` WRITE;
/*!40000 ALTER TABLE `BLC_USER_ROLE` DISABLE KEYS */;
/*!40000 ALTER TABLE `BLC_USER_ROLE` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `CATEGORY_SHIPPING_COUNTRY_XREF`
--

DROP TABLE IF EXISTS `CATEGORY_SHIPPING_COUNTRY_XREF`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `CATEGORY_SHIPPING_COUNTRY_XREF` (
  `CATEGORY_ID` bigint(20) NOT NULL,
  `SHIPPING_COUNTRY_ID` bigint(20) NOT NULL,
  KEY `FK219B8EB484C50C03` (`CATEGORY_ID`),
  KEY `FK219B8EB4E5FC5674` (`SHIPPING_COUNTRY_ID`),
  CONSTRAINT `FK219B8EB4E5FC5674` FOREIGN KEY (`SHIPPING_COUNTRY_ID`) REFERENCES `SHIPPING_COUNTRY` (`SHIPPING_COUNTRY_ID`),
  CONSTRAINT `FK219B8EB484C50C03` FOREIGN KEY (`CATEGORY_ID`) REFERENCES `PRODUCT_SKU_MYCOMPANY` (`PRODUCT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `CATEGORY_SHIPPING_COUNTRY_XREF`
--

LOCK TABLES `CATEGORY_SHIPPING_COUNTRY_XREF` WRITE;
/*!40000 ALTER TABLE `CATEGORY_SHIPPING_COUNTRY_XREF` DISABLE KEYS */;
/*!40000 ALTER TABLE `CATEGORY_SHIPPING_COUNTRY_XREF` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `PRODUCT_SHIPPING_COUNTRY_XREF`
--

DROP TABLE IF EXISTS `PRODUCT_SHIPPING_COUNTRY_XREF`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `PRODUCT_SHIPPING_COUNTRY_XREF` (
  `SHIPPING_COUNTRY_ID` bigint(20) NOT NULL,
  `PRODUCT_ID` bigint(20) NOT NULL,
  KEY `FK982817C5E5FC5674` (`SHIPPING_COUNTRY_ID`),
  KEY `FK982817C591992A72` (`PRODUCT_ID`),
  CONSTRAINT `FK982817C591992A72` FOREIGN KEY (`PRODUCT_ID`) REFERENCES `PRODUCT_SKU_MYCOMPANY` (`PRODUCT_ID`),
  CONSTRAINT `FK982817C5E5FC5674` FOREIGN KEY (`SHIPPING_COUNTRY_ID`) REFERENCES `SHIPPING_COUNTRY` (`SHIPPING_COUNTRY_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `PRODUCT_SHIPPING_COUNTRY_XREF`
--

LOCK TABLES `PRODUCT_SHIPPING_COUNTRY_XREF` WRITE;
/*!40000 ALTER TABLE `PRODUCT_SHIPPING_COUNTRY_XREF` DISABLE KEYS */;
/*!40000 ALTER TABLE `PRODUCT_SHIPPING_COUNTRY_XREF` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `PRODUCT_SKU_MYCOMPANY`
--

DROP TABLE IF EXISTS `PRODUCT_SKU_MYCOMPANY`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `PRODUCT_SKU_MYCOMPANY` (
  `RESTRICTED` bit(1) DEFAULT NULL,
  `PRODUCT_ID` bigint(20) NOT NULL,
  `ZIP_CODE_ID` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`PRODUCT_ID`),
  KEY `FKB4DFBCFF535236D2` (`ZIP_CODE_ID`),
  KEY `FKB4DFBCFF689F939C` (`PRODUCT_ID`),
  CONSTRAINT `FKB4DFBCFF689F939C` FOREIGN KEY (`PRODUCT_ID`) REFERENCES `BLC_PRODUCT_SKU` (`PRODUCT_ID`),
  CONSTRAINT `FKB4DFBCFF535236D2` FOREIGN KEY (`ZIP_CODE_ID`) REFERENCES `BLC_ZIP_CODE` (`ZIP_CODE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `PRODUCT_SKU_MYCOMPANY`
--

LOCK TABLES `PRODUCT_SKU_MYCOMPANY` WRITE;
/*!40000 ALTER TABLE `PRODUCT_SKU_MYCOMPANY` DISABLE KEYS */;
/*!40000 ALTER TABLE `PRODUCT_SKU_MYCOMPANY` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `blc_offer` (
  `OFFER_ID` bigint(20) NOT NULL,
  `APPLIES_WHEN_RULES` varchar(255) DEFAULT NULL,
  `APPLIES_TO_RULES` varchar(255) DEFAULT NULL,
...
CREATE TABLE `blc_sku` (
  ...
  `LONG_DESCRIPTION` longtext,
  `NAME` varchar(255) NOT NULL,
  `RETAIL_PRICE` decimal(19,5) NOT NULL,
  `SALE_PRICE` decimal(19,5) DEFAULT NULL,
...
--
-- Table structure for table `blc_user`
--

DROP TABLE IF EXISTS `blc_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `blc_user` (
  ...
  PRIMARY KEY (`USER_ID`),
  UNIQUE KEY `USER_NAME` (`USER_NAME`),
  KEY `USER_EMAIL_INDEX` (`EMAIL_ADDRESS`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `blc_user`
--

LOCK TABLES `blc_user` WRITE;
/*!40000 ALTER TABLE `blc_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `blc_user` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2012-08-08 15:21:27
